...
import 'package:color_scheme_picker/code_block.dart';
...
class ColorSchemeVariantColumn extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    int colorValue = selectedColor.toARGB32();
    String colorHexStr = '0x${colorValue.toRadixString(16).padLeft(8, '0')}';
    String colorSchemeCode = '''
ColorScheme.fromSeed(
  seedColor: Color($colorHexStr),
  brightness: Brightness.${brightness.name},
  contrastLevel: $contrastLevel,
  dynamicSchemeVariant: DynamicSchemeVariant.${schemeVariant.name},
)
''';
      ...
      child: Column(
        children: <Widget>[
          Padding(
            ...
            child: CodeBlockWithCopyButton(code: colorSchemeCode),
          ),
          Padding(
